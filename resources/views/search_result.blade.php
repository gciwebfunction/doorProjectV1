...
<div class="row mb-2">
    <div class="col-md-12 px-0">
        ...
        <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
            <form action="/search_result" method="POST" id="">
            @csrf <!-- {{ csrf_field() }} -->
                <div class="lead my-3 text-center">
                    <input type="text" value="{{ $searched ?? '' }}" name="search" required class="searchbar">
                    <button type="submit" class="btn btn-secondary btn-lg px-4 dark:text-white-500 hover:text-gray-800">
                        Search
                    </button>
                </div>
            </form>
        ...
        <div class="col-md-6">
            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                    ...
                    <p class="card-text mb-auto">{{$category->category_note}}</p>
                    <a href="/category_dashboard/id?category_list={{$category->id}}" class="stretched-link">Sign in to order...</a>
                </div>
                <div class="col-auto d-none d-lg-block">
                    <img src="/storage/category_image/{{$category->image}}" class="img-fluid border rounded-3 shadow-lg mb-3"
                         alt="{{$category->category_name}}" width="238" height="200" loading="lazy">
                </div>
            </div>
        </div>
    @endforeach
