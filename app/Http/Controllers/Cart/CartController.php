...
class CartController extends Controller
{
    ...
    public function addDoorToCart($productId, $cartId)
    {
        ...
        if (isset($data['handle_color_option_select']))
            $handleColorOption = Product\Door\AdditionalOption::find($data['handle_color_option_select']);
