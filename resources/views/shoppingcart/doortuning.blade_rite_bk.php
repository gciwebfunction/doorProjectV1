            ...
            @if($addOn->is_custom_option>0)
                <div class="customOption addOn-{{$addOn->id}}">
                    <option value="{{$addOn->id}}" class=" addOnOption"
                            id="m-{{$addOn->is_custom_option}}-{{$addOn->door_measurement_id}}-{{$addOn->price}}">{{$addOn->name}}</option>
                </div>

            @else
                <div class="addOn-{{$addOn->id}}">
                    <option value="{{$addOn->id}}" class="{{$addOn->group_name}} addOnOption"
                            id="m-{{$addOn->group_name}}-{{$addOn->door_measurement_id}}-{{$addOn->price}}">{{$addOn->name}}</option>
                </div>
            @endif
        @endforeach
