                    ...
                    <div class="col-md-8 mb-4">
                        <div class="form-outline mb-4">
                            ...
                            <input type="text"
                                   ...
                                   name="expected_shipping_date" required placeholder="MM-dd-YYYY" value="{{  date('m-d-Y' , strtotime( '+20 days'))   }}"
...
{{--                                            </div>--}}
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <textarea class="form-control" id="addInfo" name="additionalInformation" rows="4">{{ old('additionalInformation') }}</textarea>
                                </div>
