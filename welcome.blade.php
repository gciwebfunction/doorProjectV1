...
<div class="row mb-2">
    <div class="col-md-12 px-0">
        ...
        <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
            <form action="/o/search" method="POST" id="">
            @csrf <!-- {{ csrf_field() }} -->
                <div class="lead my-3 text-center">
                    <input type="text" name="search" required class="searchbar">
...
<div class="row mb-2">
    @foreach($categories as $category) @php die('sdfdsfs'); @endphp
        ...
        <div class="col-md-6">
            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                    ...
                    <a href="/category_dashboard/{{$category->id}}" class="stretched-link">Sign in to order...</a>
                </div>
